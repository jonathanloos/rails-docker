...
docker build --no-cache -f Dockerfile.slim.ruby-3.0.4 -t krsyoung/rails-build:3.0.4-slim-buster .
docker build --no-cache -f Dockerfile.slim-bullseye.ruby-3.1.0 -t krsyoung/rails-build:3.1.0-slim-bullseye .
# 3.1.3
docker build --no-cache -f Dockerfile.slim-bullseye.ruby-3.1.3 -t krsyoung/rails-build:3.1.3-slim-bullseye .
docker push krsyoung/rails-build:3.1.3-slim-bullseye

# 3.1.2
docker build --no-cache -f Dockerfile.slim-bullseye.ruby-3.1.2 -t krsyoung/rails-build:3.1.2-slim-bullseye .
docker push krsyoung/rails-build:3.1.2-slim-bullseye
...
docker push krsyoung/rails-build:3.0.4-slim-buster
# 3.1.0
docker build --no-cache -f Dockerfile.slim-bullseye.ruby-3.1.0 -t krsyoung/rails-build:3.1.0-slim-bullseye .
