...
# 3.2.2
docker build --no-cache -f Dockerfile.slim-bullseye.ruby-3.2.2 -t krsyoung/rails-build:3.2.2-slim-bullseye .
docker push krsyoung/rails-build:3.2.2-slim-bullseye
